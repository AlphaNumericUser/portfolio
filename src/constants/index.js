  ...
  export const myCertifications = [
    {
      ...
      summary: "I learned to develop functional and visually appealing mobile applications using Flutter and Dart, applying state management, REST APIs, Firebase, SQLite, notifications, camera, maps, forms, local storage, and deployment to the App Store and Play Store.",
    ...
    },
    {
      ...
      summary: "I developed professional mobile applications using Flutter and Dart, applying best practices such as Clean Code. I mastered state management with Riverpod, Bloc, and Provider, integration with REST APIs, local databases, push notifications, and publishing on the App Store and Play Store.",
    ...
    },
    {
      ...
      summary: "I expanded my Flutter and Dart skills by utilizing device hardware resources: sensors, gyroscope, magnetometer, biometrics, and permissions. I implemented streams, deep-linking, background tasks, local databases with Isar, AdMob, local authentication, maps, and optimized projects using Go Router.",
    ...
    },
    {
      ...
      summary: "I completed the Python Pro bootcamp with 100 projects in 100 days, mastering Python 3, automation, web development (Flask, REST, APIs), data science, SQL databases, deployment, and version control. I used libraries such as Pandas, NumPy, Matplotlib, Selenium, and Flask.",
    ...
    },
    {
      ...
      summary: "I learned web development from scratch to professional level, creating projects with HTML, CSS, JavaScript, React, Node.js, Express, and PostgreSQL. I mastered REST APIs, version control with Git, deployment, responsive design, and explored modern technologies such as Web3, blockchain, and smart contracts.",
    ...
    },
    {
      ...
      summary: "I learned modern JavaScript by working with classes, modules, private properties, promises, generator functions, fetch, DOM manipulation, Vite, NPM, and Git. I developed projects such as a Blackjack game, a CRUD app without frameworks, and a task list deployed with GitHub Pages.",
    ...
    },
    {
      ...
      summary: "I learned to build applications with React using hooks, context, and Redux. I implemented unit tests with Jest Testing Library. I developed fullstack projects with MERN, authentication with JWT and Google Sign-In, production deployments, and database management with MongoDB and Firestore.",
